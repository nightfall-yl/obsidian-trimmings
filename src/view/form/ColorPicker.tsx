...
export function ColorPicker(props: {
	...
	return (
		<>
			<span
				className="color-indicator plugin-config-color-indicator"
				style={{
			...
			></span>
			{props.color && (
				<div className="color-label plugin-config-color-label">
					<span>{props.color ?? ""}</span>
					<span
						className="color-reset-button plugin-config-color-reset-button"
						onClick={() => {
							if (props.onReset) {
